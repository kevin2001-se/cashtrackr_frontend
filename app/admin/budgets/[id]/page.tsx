...
import { getBudgetId } from "@/src/services/budget";
...
export default async function BudgetDetailsPage({params}: {params: {id: string}}) {
    ...
    const totalSpent = budget.expenses.reduce((acc, expense) => acc + +expense.amount , 0)
    const totalAvailable = +budget.amount - totalSpent;

    const porcentaje = ((totalSpent / +budget.amount) * 100)
